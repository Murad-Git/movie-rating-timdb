...
import { Base_Url } from '../api/hello';
      ...
      <div className='px-5 sm:grid md:grid-cols-2 xl:grid-cols-3 3xl:flex flex-wrap justify-center'>
        ...
        <div className='movie-content border-b-2 border-gray-50'>
          ...
          <section>
            ...
            <ScrollWrap mainImg={viewList} num={4} />
        ...
        <div className='hidden video-player flex fixed flex-col h-1/2 w-full z-50 overflow-hidden left-3/4 transform -translate-x-1/2 -translate-y-1/2'>
